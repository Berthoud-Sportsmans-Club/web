      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-gray max-w-3xl space-y-6">
          ...
          <div className="card p-6">
            <h2 className="font-serif text-xl font-bold text-forest-900 dark:text-forest-100 mb-3">Membership Card</h2>
          ...
          <div className="card p-6">
            <h2 className="font-serif text-xl font-bold text-forest-900 dark:text-forest-100 mb-3">Annual Dues</h2>
            <p className="text-gray-700 dark:text-gray-200">
          ...
          <div className="card p-6">
            <h2 className="font-serif text-xl font-bold text-forest-900 dark:text-forest-100 mb-3">Participation Requirement</h2>
            <p className="text-gray-700 dark:text-gray-200">
          ...
          <div className="card p-6">
            <h2 className="font-serif text-xl font-bold text-forest-900 dark:text-forest-100 mb-3">Boat Registration</h2>
            <p className="text-gray-700 dark:text-gray-200">
          ...
          <div className="card p-6">
            <h2 className="font-serif text-xl font-bold text-forest-900 dark:text-forest-100 mb-3">General Reminders</h2>
            <ul className="space-y-2 text-gray-700 dark:text-gray-200">
              ...
              <li>Please review the{' '}
                <Link href="/members/violations" className="text-forest-600 dark:text-forest-400 hover:text-gold-600 dark:hover:text-gold-400 underline">
                  Rule Violation Policy
                </Link>{' '}(updated August 11, 2017).
              </li>
              <li>
                To receive club news by email, use our{' '}
                <Link href="/contact" className="text-forest-600 dark:text-forest-400 hover:text-gold-600 dark:hover:text-gold-400 underline">
                  Contact page
                </Link>{' '}
          ...
          <div className="card p-6">
            <h2 className="font-serif text-xl font-bold text-forest-900 dark:text-forest-100 mb-3">Member Handbook</h2>
            <p className="text-gray-700 dark:text-gray-200">
            ...
            <p className="text-gray-700 dark:text-gray-200 mt-3">
              ...
              <Link href="/members/documents" className="text-forest-600 dark:text-forest-400 hover:text-gold-600 dark:hover:text-gold-400 underline">
                Documents section
              </Link>.
            </p>
          </div>
