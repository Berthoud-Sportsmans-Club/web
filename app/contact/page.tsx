        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-5">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-forest-900 mb-0.5">Mailing Address</p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-forest-900 mb-0.5">Membership</p>
              ...
              {/* External resources */}
              <div className="bg-white rounded-xl p-6 border border-parchment">
                  ...
                  {[
                    ...
                    <li key={href}>
                      <a
                        ...
                        className="flex items-center gap-2 text-sm text-forest-700 hover:text-gold-600 transition-colors"
                      >
              ...
              <form className="space-y-5">
                ...
                <div>
                  ...
                  <select
                    ...
                    name="subject"
                    className="w-full rounded-md border border-gray-200 px-3 py-2 text-sm
                               focus:outline-none focus:ring-2 focus:ring-forest-400 focus:border-transparent bg-white"
                  >
